...
async def export_with_progress():
    ...
    1. UX de Alta Calidad: Permite al frontend mostrar una barra de progreso real.
    2. Eficiencia: Usa una sola conexión HTTP unidireccional, más ligero que WebSockets.
    3. Anti-Timeouts: Mantiene la conexión viva enviando datos constantemente.
    """
...
async def export_ui():
    ...
    <body>
        ...
        <script>
            ...
            // Nota: Se usa ruta relativa '/stream/export-progress' según configuración en api.py
